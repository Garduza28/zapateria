...
.login-box a:hover {
  ...
  <body>
    <div class="login-box">
      <img src="ZapatosF/BotasH4.jpg" class="avatar" alt="Avatar Image">
      <h1 class="NoH1">Agregar Botas</h1>
      <form action="Agregar_Botas2.php?CVE=<?php echo $Clave; ?>" method="POST">
        <!-- USERNAME INPUT -->
        <br>
        ...
        <select  name="NOMBRE_COLOR" type="range" class="form-select">
           ...
           <option>Negro/Amarillo</option>
            ...
            <option>Rojo</option>
            <option selected>Ferrero/Cafe</option>
...
<option selected>National Geographic</option>
      </select>
...
<option selected>Botas Varon</option>
<option>Botas Generales</option>
      </select>
        <label for="password">Nombre Bota</label>
        <input type="text" placeholder="Ingresa Nombre del Zapato" name="NOMBRE_ZAP" required>
         <label for="password">Imagen Bota</label>
         <br>
