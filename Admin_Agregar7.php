...
.login-box a:hover {
  ...
  <body>
    <div class="login-box">
      ...
      <h1 class="NoH1">Agregar Flats</h1>
      <form action="Agregar_Flats2.php?CVE=<?php echo $Clave; ?>" method="POST">
        <!-- USERNAME INPUT -->
        <br>
