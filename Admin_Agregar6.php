...
<br>
   ...
   <div id="linea">
  <h1 class="NoH11">Zapatos Casuales</h1>
</div>
...
.login-box a:hover {
  ...
  <body>
    <div class="login-box">
      <img src="ZapatosF/CasualJ1.jpg" class="avatar" alt="Avatar Image">
      <h1 class="NoH1">Agregar Zapatos Casuales</h1>
      <form action="Agregar_Casuales2.php?CVE=<?php echo $Clave; ?>" method="POST">
        <!-- USERNAME INPUT -->
        <br>
...
<option selected>Custom Style</option>
...
<option selected>Casuales Niños</option>
<option>Casuales Hombre</option>
      </select>
