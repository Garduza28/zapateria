...
<br>
  <?php 
                                    ...
                                    $mes3 = $año.'-'.'0'.$mes2.'%';
                                     ?>
<div id="linea">
 <h1 class="NoH112">Historial Dia Anterior <?php echo $ayer ; ?></h1>
</div><br>
                      <div class="projects">
                    <div class="card">
                        <div class="card-header">
...
where Z.CVE_ZAPATO=V.CVE_ZAPATO and V.CVE_MEMBRESIA=C.CVE_MEMBRESIA and C.CVE_MEMBRESIA=U.CVE_USUARIOS and T.CVE_TALLAS=V.CVE_TALLAS and V.FECHA_AC like ('$ayer')") or die($conn -> error);
                                          while ($fila = mysqli_fetch_array($resultado)) {
                                         ?>
                                         <center>
                                        <tr> 
