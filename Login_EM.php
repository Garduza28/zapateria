...
.login-box a:hover {
  ...
  <body>
    <div class="login-box">
      <img src="IMG/AVATARLO2.png" class="avatar" alt="Avatar Image">
      <h1 class="NoH1">Ingreso Empleado</h1>
      <form action="ValidarAD.php" method="POST" required>
        <!-- USERNAME INPUT -->
        <br>
        <label for="username">Clave Empleado</label>
        <input type="text" placeholder="Ingresa Membresía" name="CVE_ADMINISTRADOR" required>
        <!-- PASSWORD INPUT -->
        <label for="password">RFC</label>
        <input type="text" placeholder="RFC" name="RFC">
         <label for="password">Contraseña</label>
        <input type="password" placeholder="Contraseña" name="CONTRASENA_ADM" required>
