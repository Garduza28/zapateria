  ...
  if ($filas) {
    ...
    header("location: PRUEBA ES.php");
               ...
               include("PHP/conexion.php");
                ...
                $sql.="values ('$Clave_Za','$Clave_Co','$Clave_Mar','$Clave_Pro','/A01T2','$Precio_Za','$Stock','$Nombre_Zapat','Femenino','Zapatillas','$Imagen_Za')";

                $resultado =$conn->query($sql);
                header("location:Admin_Agregar2.php?CVE=$Clave");
