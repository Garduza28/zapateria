...
.login-box a:hover {
  ...
  <body>
    <div class="login-box">
      <img src="ZapatosF/Tacones2.jpg" class="avatar" alt="Avatar Image">
      <h1 class="NoH1">Agregar Zapatilla</h1>
      <form action="Agregar_Zapatillas3.php?CVE=<?php echo $Clave; ?>" method="POST">
        <!-- USERNAME INPUT -->
        <br>
        ...
        <select  name="NOMBRE_COLOR" type="range" class="form-select">
            ...
            <option selected>Negro/Fiusha</option>
...
<option selected>Miracol by Mama lola</option>
<option>Puma</option>
<option>Pirma</option>
<option>Suns</option>
...
<option>National Geographic</option>
        ...
        <label for="password">Nombre Zapato</label>
        <input type="text" placeholder="Ingresa Nombre delZapato" name="NOMBRE_ZAP" required>
         <label for="password">Imagen Zapato</label>
         <br>
