...
<br>
<div id="linea">
  <h1 class="NoH11">Botas de Todo Tipo</h1>
  <br>
</div>
<br>
       <div id="line2">
  ...
  <ul id="linea2" class="slider">
    <li id="slide1">
      <img src="ZapatosF/BotasH2.jpg">
    </li>
    <li id="slide2">
      <img src="ZapatosF/BotasH9.jpg" >
    </li>
    <li id="slide3">
      <img src="ZapatosF/BotasH4.jpg">
    </li> 
    <li id="slide4">
      <img src="ZapatosF/BotasH1.jpg">
    </li> 
     <li id="slide5">
      <img src="ZapatosF/BotasH7.jpg">
    </li> 
  </ul>
  <ul class="menu">
    <li>
...
<br>
   <div id="linea">
    <h1 class="NoH1">Botas De Varon</h1>
</div>
<div class="container">
      <?php 
  include("PHP/conexion.php");
  $resultado = $conn ->query("select TIPO_ZAPATO,PRECIO,NOMBRE_ZAP,IMAGEN_ZA,CVE_ZAPATO
    from zapatos 
    where TIPO_ZAPATO in ('Botas Varon')") or die($conn -> error);
  while ($fila = mysqli_fetch_array($resultado)) {
 ?>
    <div class="item"> 
      <br>
      <h3 class="rojo">Precio:<?php echo $fila ['PRECIO']; ?>$</h3><p><b>Talla:=26-29</b></p>
      <center>
...
<?php } ?>
    ...
    <div id="linea">
    <h1 class="NoH1">Botas Casuales</h1>
</div>
<div class="container">
    <?php 
  include("PHP/conexion.php");
  $resultado = $conn ->query("select TIPO_ZAPATO,PRECIO,NOMBRE_ZAP,IMAGEN_ZA,CVE_ZAPATO
    from zapatos 
    where TIPO_ZAPATO in ('Botas Generales')") or die($conn -> error);
  while ($fila = mysqli_fetch_array($resultado)) {
 ?>
    <div class="item"> 
      <br>
      <h3 class="rojo">Precio:<?php echo $fila ['PRECIO']; ?>$</h3><p><b>Talla:=26-28</b></p>
      <center>
        <img src="ZapatosF/<?php echo $fila ['IMAGEN_ZA'];?>" width="220px" height="190px"></center>
      <div class="item-text">
        <p><?php echo $fila ['NOMBRE_ZAP']; ?></p>
