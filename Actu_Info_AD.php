...
.register-bg {
 ...
 ?>               <center>
        ...
        <?php } ?>
                      ...
                      <a href="indexdashboard.php?CVE=<?php echo $Clave; ?>" id="FLO2" class="font-weight-bold">Ir a Administrador</a><br><br>
                        <a href="USUARIO EJEMPLO2.php?CVE=<?php echo $Clave; ?>" id="FLO2"  class="font-weight-bold">Regresar a Perfil</a>
                        <br>
