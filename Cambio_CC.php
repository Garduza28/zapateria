...
.login-box a:hover {
 ...
 ?>
  ...
  <input  name="CVE_MEMBRESIA" type="text"  placeholder="Ingresa el Numero de tu Membresía">
  <br><br>
   <label class="font-weight-bold">Nueva Contraseña <span class="text-danger">*</span></label>
   <input name="CONTRASENA_CLI" type="password" placeholder="Ingresa una contraseña">
      <br>
   <br>
  <button type="submit" class="btn btn-primary">Cambiar</button>
  </form>
<?php } ?>
   <a  href="Zapateria.php?CVE=<?php echo $Clave; ?>"><p>Ir a Inicio</p></a>
  <a href="USUARIO EJEMPLO.php?CVE=<?php echo $Clave;?>"><p>Regresar a Perfil</p></a>
