...
<body >
  ...
  <nav class="navbar navbar-expand-md navbar-dark fixed-top bg-dark">
    <div class="container-fluid">
      <a class="NoH3" class="navbar-brand" href="Admin_Ped_Emp.php?CVE=<?php echo $Clave; ?>">Regresar a Pedidos</a>
    ...
    <section class="seccion-perfil-usuario">
            ...
            <div class="perfil-usuario-portada">
                <div class="perfil-usuario-avatar">
                  <img src="IMG/<?php echo $fila ['IMAGEN_USU'];?>" width="40px" height="170px">
                   <a href="Cambio_IMGEM.php?CVE=<?php echo $Clave;?>"><button class="boton-avatar"><i class="far fa-image"></i></button></a>
                </div>
        ...
        <div class="perfil-usuario-body">
            <div class="perfil-usuario-bio">
                <h3 class="titulo"><?php echo $fila ['NOMBRE'];?>  <?php echo $fila ['APELLIDO_PATERNO'];?> <?php echo $fila ['APELLIDO_MATERNO'];?> <center><p>Empleado</p></center></h3><?php } ?>
...
.btn {
    ...
    min-width: 10rem;
            ...
            <br>
            <a  href="Actu_Info_EM2.php?CVE=<?php echo $Clave; ?>"><button type="submit" class="btn btn-warning">Cambiar Información</button></a>
        </div>
    </section>
    <!--====  End of html  ====-->
