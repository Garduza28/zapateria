...
.login-box a:hover {
 ...
 ?>
   <div class="login-box">
      ...
      <form action="Actu_Perfil3.php?CVE=<?php echo $Clave;?>" method="POST"> 
  	<br><br>
 	...
 	<br>
 	<a href="USUARIO EJEMPLO3.php?CVE=<?php echo $Clave;?>"><button type="submit" >Regresar a Perfil</button></a>
    </div>
<?php } ?>
 </html>
