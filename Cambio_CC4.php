...
.login-box a:hover {
  ...
  $resultado = $conn ->query("select * from usuarios where CVE_USUARIOS='$Clave2'") or die($conn -> error);
 ...
 ?>
    <div class="login-box">
     ...
     <form action="Actu_Contra4.php?CVE=<?php echo $Clave; ?><?php echo "&"; ?>CVE2=<?php echo $Clave2; ?>" method="POST">
   <label class="font-weight-bold">Contraseña Provicional: <span class="text-danger">*</span></label>
   <input name="CONTRASENA_ADM" type="password" placeholder="Ingresa Contraseña Provicional">
      <br>
   <br>
  <button type="submit" class="btn btn-primary">Cambiar</button>
  </form>
<?php } ?> 
   <a  href="Admin_AD.php?CVE=<?php echo $Clave; ?>"><p>Ir a Administrador</p></a>
    </div>
 </html>
