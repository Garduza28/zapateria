...
.login-box a:hover {
  ...
  <body>
    <div class="login-box">
      <img src="ZapatosF/SandaliaN3.jpg" class="avatar" alt="Avatar Image">
      <h1 class="NoH1">Agregar Sandalias</h1>
      <form action="Agregar_Sandalias2.php?CVE=<?php echo $Clave; ?>" method="POST">
        <!-- USERNAME INPUT -->
        <br>
...
<option selected>Sandalias Damas</option>
<option>Sandalias NIñas</option>
<option>Sandalias Niños</option>
      </select>
        <label for="password">Nombre Sandalia</label>
