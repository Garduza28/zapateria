...
<br>
<div id="linea">
  <h1 class="NoH11">Calzado Casual</h1>
  <br>
</div>
<br>
       <div id="line2">
  ...
  <ul id="linea2" class="slider">
    <li id="slide1">
      <img src="ZapatosF/SandaliasD22.jpg">
    </li>
    <li id="slide2">
      <img src="ZapatosF/CasualJ2.jpg" >
    </li>
    <li id="slide3">
      <img src="ZapatosF/ZapatoH2.jpg">
    </li> 
    <li id="slide4">
      <img src="ZapatosF/ZapatoH1.jpg">
    </li> 
     <li id="slide5">
      <img src="ZapatosF/CasualJ3.jpg">
    </li> 
  </ul>
  <ul class="menu">
    <li>
...
<div class="container">
  ...
  $resultado = $conn ->query("select TIPO_ZAPATO,PRECIO,NOMBRE_ZAP,IMAGEN_ZA,CVE_ZAPATO
    from zapatos 
    where TIPO_ZAPATO in ('Casuales Hombre')") or die($conn -> error);
...
<div class="container">
  ...
  $resultado = $conn ->query("select TIPO_ZAPATO,PRECIO,NOMBRE_ZAP,IMAGEN_ZA,CVE_ZAPATO
    from zapatos 
    where TIPO_ZAPATO in ('Sandalias Damas')") or die($conn -> error);
  while ($fila = mysqli_fetch_array($resultado)) {
 ?>
    <div class="item"> 
      <br>
      <h3 class="rojo">Precio:<?php echo $fila ['PRECIO']; ?>$</h3><p><b>Talla:=22-25</b></p>
      <center>
        <img src="ZapatosF/<?php echo $fila ['IMAGEN_ZA'];?>" width="220px" height="190px"></center>
      <div class="item-text">
        <p><?php echo $fila ['NOMBRE_ZAP']; ?></p>
...
<div class="container">
  ...
  $resultado = $conn ->query("select TIPO_ZAPATO,PRECIO,NOMBRE_ZAP,IMAGEN_ZA,CVE_ZAPATO
    from zapatos 
    where TIPO_ZAPATO in ('Flats')") or die($conn -> error);
  while ($fila = mysqli_fetch_array($resultado)) {
 ?>
    <div class="item"> 
      <br>
      <h3 class="rojo">Precio:<?php echo $fila ['PRECIO']; ?>$</h3><p><b>Talla:=12-14</b></p>
       <center>
        <img src="ZapatosF/<?php echo $fila ['IMAGEN_ZA'];?>" width="220px" height="190px"></center>
      <div class="item-text">
        <p><?php echo $fila ['NOMBRE_ZAP']; ?></p>
