...
<br>
<div id="linea">
  <h1 class="NoH11">Todo Tipo de Tenis</h1>
  <br>
</div>
<br>
       <div id="line2">
  ...
  <ul id="linea2" class="slider">
    <li id="slide1">
      <img src="ZapatosF/TenisD.jpg">
    </li>
    <li id="slide2">
      <img src="ZapatosF/TenisJ2.jpg" >
    </li>
    <li id="slide3">
      <img src="ZapatosF/TenisH1.jpg">
    </li> 
    <li id="slide4">
      <img src="ZapatosF/TenisJ1.jpg">
    </li> 
     <li id="slide5">
      <img src="ZapatosF/TenisH22.jpg">
    </li> 
  </ul>
  <ul class="menu">
    <li>
...
<div class="container">
  ...
  $resultado = $conn ->query("
    select TIPO_ZAPATO,PRECIO,NOMBRE_ZAP,IMAGEN_ZA,CVE_ZAPATO
    from zapatos 
    where TIPO_ZAPATO in ('Tenis Varon')") or die($conn -> error);
  while ($fila = mysqli_fetch_array($resultado)) {
 ?>
    <div class="item"> 
      <br>
      <h3 class="rojo">Precio:<?php echo $fila ['PRECIO']; ?>$</h3><p><b>Talla:=25-27</b></p>
      <center>
      ...
      <div class="item-text">
        <p><?php echo $fila ['NOMBRE_ZAP']; ?></p>
           ...
           <br>
         <form action="VAMOS AYAAA.php?id=<?php echo $fila ['CVE_ZAPATO']; ?><?php echo '&'; ?>CVE=<?php echo $Clave;?>" method="POST">
          <p><b>Cantidad:</b></p>
             <input type="number" name="CANTIDAD" class="form-select2" value="1">
           <p><b>Tallas:</b></p>
            <select name="NUM_TALLAS" type="range" class="form-select">
      ...
      <br> 
      <button type="submit" class="btn btn-danger">Agregar a Pedidos</button>
         </form>
      </div>
    </div>
<?php } ?>
 ...
 <div id="linea">
    <h1 class="NoH1">Tenis De Damas</h1> 
</div>
<div class="container">
  <?php 
  include("PHP/conexion.php");
  $resultado = $conn ->query("select TIPO_ZAPATO,PRECIO,NOMBRE_ZAP,IMAGEN_ZA,CVE_ZAPATO
    from zapatos 
    where TIPO_ZAPATO in ('Tenis Damas')") or die($conn -> error);
  while ($fila = mysqli_fetch_array($resultado)) {
 ?>
    <div class="item"> 
      <br>
      <h3 class="rojo">Precio:<?php echo $fila ['PRECIO']; ?>$</h3><p><b>Talla:=23-26</b></p>
      <center>
        <img src="ZapatosF/<?php echo $fila ['IMAGEN_ZA'];?>" width="220px" height="190px"></center>
      <div class="item-text">
        <p><?php echo $fila ['NOMBRE_ZAP']; ?></p>
...
<div class="container">
  ...
  $resultado = $conn ->query("select TIPO_ZAPATO,PRECIO,NOMBRE_ZAP,IMAGEN_ZA,CVE_ZAPATO
    from zapatos 
    where TIPO_ZAPATO in ('Tenis Niñas')") or die($conn -> error);
  while ($fila = mysqli_fetch_array($resultado)) {
 ?>
    <div class="item"> 
      <br>
      <h3 class="rojo">Precio:<?php echo $fila ['PRECIO']; ?>$</h3><p><b>Talla:=12-15</b></p>
      <center>
        <img src="ZapatosF/<?php echo $fila ['IMAGEN_ZA'];?>" width="220px" height="190px"></center>
      <div class="item-text">
        <p><?php echo $fila ['NOMBRE_ZAP']; ?></p>
