...
<?php 
 ...
 <?php 
  ...
  $sql.="values ('$Clave_Za','$Clave_Co','$Clave_Mar','$Clave_Pro','/A01T8','$Precio_Za','$Stock','$Nombre_Zapat','$Genero','$Tipo_Za','$Imagen_Za')";
...
<?php  
  header("location:Admin_Agregar4.php?CVE=$Clave");
